...
import { execToast, createSocket } from './utils'

const socket = createSocket('hook')

const connectedMessage = () => {
  execToast('Remote Devtools Connected', 'normal')
}

const disconnectedMessage = () => {
  execToast('Remote Devtools Disconnected', 'error')
}
